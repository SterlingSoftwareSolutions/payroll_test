        ...
        <div class="content container-fluid">
            ...
            <form action="{{ route('all/attendance/search') }}" method="POST">
                ...
                <div class="row filter-row">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group">
                            <input type="number" class="form-control floating" name="select_year"
                                                    ...
                                                    <div class="col-md">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" style="width: 100%;"
                                                                tabindex="-1" aria-hidden="true" id="a_id"
                                                                name="attendance_id" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md">
                                                        <div class="form-group">
                                                            <label class="col-form-label">Select Employee <span
                                                                    class="text-danger">*</span></label>
                                                            <input class="form-control" style="width: 100%;"
                                                                tabindex="-1" aria-hidden="true" id="e_name"
                                                    ...
                                                    <div class="col-md">
                                                        <div class="form-group">
                                                            <label class="col-form-label">Select Date <span
                                                                    class="text-danger">*</span></label>
                                                            <input class="form-control" style="width: 100%;"
                                                                tabindex="-1" aria-hidden="true" id="e_date"
                                                                type="date" name="date">
                                                            @error('date')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                ...
                                <div class="col-md">
                                    <div class="form-group">
                                        <label class="col-form-label">Attendance ID <span
                                                class="text-danger">*</span></label>
                                        <input class="form-control" style="width: 100%;" tabindex="-1"
                                            aria-hidden="true" id="attendance_id" name="attendance_id"
                                            value="{{ $next_id }}" disabled>
                                        @error('attendance_id')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md">
                                    <div class="form-group">
                                        <label class="col-form-label">Select Date <span
                                                class="text-danger">*</span></label>
                                        <input class="form-control" style="width: 100%;" tabindex="-1"
                                            aria-hidden="true" id="date" type="date" name="date">
                                        @error('date')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
