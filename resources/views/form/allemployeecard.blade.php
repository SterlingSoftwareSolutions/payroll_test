                            ...
                            <tbody> 
                                ...
                                @foreach ($employee as $employe)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $employee->c_number}}</td>
                                            <td class="text-center">{{ $employee->j_title}} </td>
                                            <td class="text-right">
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-left">
                                                        <a class="dropdown-item leaveUpdate" data-toggle="modal" data-id="'.$employee->id.'" data-target="#view"><i class="fa fa-eye m-r-5"></i> View</a>
                                                        <a class="dropdown-item leaveUpdate" data-toggle="modal" data-id="'.$employee->id.'" data-target="#edit_leave"><i class="fa fa-pencil m-r-5"></i> Edit</a>
