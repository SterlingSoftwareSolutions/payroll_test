                    ...
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        nicInput.addEventListener('input', function () {
                            ...
                            if (format1Regex.test(nicValue) || format2Regex.test(nicValue)) {
                                ...
                                // Invalid NIC format
                                nicInput.setCustomValidity('NIC should be either 10 characters with 9 numbers and the last one being "x", "X", "v", or "V", or 12 characters with all numbers.');
                            }
                        });
                    });
                </script>
                    ...
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        contactNumberInput.addEventListener('input', function () {
                            ...
                            if (contactNumberRegex.test(contactNumberValue)) {
                                ...
                                contactNumberInput.setCustomValidity('Please enter a valid contact number starting with "0" and having 10 digits.');
                            }
                        });
                    });
                </script>
                                            ...
                                            document.addEventListener('DOMContentLoaded', function () {
                                                ...
                                                accountNumberInput.addEventListener('input', function () {
                                                    ...
                                                    if (regex.test(value)) {
                                                        ...
                                                        accountNumberInput.setCustomValidity('Please enter a valid account number with at least 5 digits.');
                                                    }
                                                });
                                            });
                                        </script>
                                            ...
                                            document.addEventListener('DOMContentLoaded', function () {
                                                ...
                                                basicSalaryInput.addEventListener('input', function () {
                                                    ...
                                                    if (numbersRegex.test(basicSalaryValue)) {
                                                        ...
                                                        basicSalaryInput.setCustomValidity('Please enter a valid basic salary with only numeric characters.');
                                                    }
                                                });
                                            });
                                        </script>
                                            ...
                                            newIncrementDiv.innerHTML = `
                                                <div class="row"><br> <hr style="border-color: #979797;">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" id="type${incrementCount}" name="type[]">
                                                            <option value="" disabled selected>Select a type</option> <!-- Placeholder option -->
                                                            <option value="increments">Increments</option>
                                                            <option value="deductions">Deductions</option>
                                                        </select>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control" name="increment_name[]">
                                                    </div>
                                                    <div class="row mb-3 ">
