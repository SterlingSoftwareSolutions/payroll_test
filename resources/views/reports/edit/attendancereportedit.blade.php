        ...
        <div class="content container-fluid">
            ...
            {{-- <form method="POST" action="{{ route('reports.update.attendancereport', $attendanceReport->id) }}">
             ...
             <div class="modal-body">
                {{-- <form action="{{ route('all/attendance report/save') }}" method="POST" style="border:1px solid #ccc;"> --}}
                <form action="" method="POST"
                    onsubmit="return validateForm()" style="border:1px solid #ccc;">
                    {{-- <form action="{{ route('all/attendane report/save') }}" method="POST" onsubmit="return validateForm()" style="border:1px solid #ccc;"> --}}
                    @csrf
                    <h3 style="border: 1px solid #ccc; padding-top:30px; padding-bottom: 30px; padding-left:20px; ">Attendance Report Edit Form</h3>
                    @csrf
                    <!-- Your form fields go here -->
                    ...
                    <div class="row" style="padding-left:20px; padding-right:20px;">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true"
                                 id="etf_no" name="etf_no" value="" required>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true"
                                    id="f_name" name="f_name" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true"
                                    id="l_name" name="l_name" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true"
                                    id="full_name" name="full_name" value="" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true"
                                    id="c_number" name="c_number" value="" required>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-form-label">No pay leaves  <span class="text-danger">*</span></label>
                                <input class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true"
                                 id="etf_no" name="etf_no" value="" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-form-label">Annual Leaved Taken <span class="text-danger">*</span></label>
                                <input class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true"
                                    id="full_name" name="full_name" value="" required>
                            </div>
                        </div>
