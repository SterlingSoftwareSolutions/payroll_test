    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="{{ set_active(['home', 'em/dashboard']) }} submenu" id="sidebar-menu">
                    <a href="#" class="{{ set_active(['home', 'em/dashboard']) }}"
                        style="{{ request()->is('home') ? 'background-color: #f43b48; color: white;' : '' }}">
                        <i class="la la-dashboard"></i>
                        <span style="{{ request()->is('home') ? 'color: white;' : '' }}"> Dashboard</span>
                        <span class="menu-arrow"></span>
                    </a>
                    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                        <li><a href="{{ route('home') }}"
                                style="{{ request()->is('home') ? 'color: #f43b48;' : '' }}">Admin Dashboard</a></li>
                ...
                @if (Auth::user()->role_name == 'Admin')
                    ...
                    <li
                        ...
                        <a href="#"
                            class="{{ set_active(['search/user/list', 'userManagement', 'activity/log', 'activity/login/logout']) }}"
                            style="{{ request()->is(['search/user/list', 'userManagement', 'activity/log', 'activity/login/logout']) ? 'background-color: #f43b48; color: white;' : '' }}">
                            <i class="la la-user-secret"></i>
                            <span
                                style="{{ request()->is(['search/user/list', 'userManagement', 'activity/log', 'activity/login/logout']) ? 'color: white;' : '' }}">
                                User Controller</span>
                            <span class="menu-arrow"></span>
                        </a>
                        <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                            <li><a class="{{ set_active(['search/user/list', 'userManagement']) }}"
                                    href="{{ route('userManagement') }}">All User</a></li>
                ...
                <li
                    ...
                    <a href="#"
                        ...
                        style="{{ request()->is([
                            ...
                            ? 'background-color: #f43b48; color: white;'
                            : '' }}">
                    ...
                    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                        <li><a class="{{ set_active(['all/employee/list']) }}"
                        ...
                        <li><a class="{{ set_active(['attendance/employee/page']) }}"
                                href="{{ route('attendance/employee/page') }}">Attendance
                                <!----(Employee)  -------></a>
                        </li>
                        <li><a class="{{ set_active(['form/departments/page']) }}"
                                href="{{ route('form/departments/page') }}">Departments</a></li>
                ...
                <!-- <li class="{{ set_active(['form/salary/page', 'form/payroll/items']) }} submenu">
                    <a href="#" class="{{ set_active(['form/salary/page', 'form/payroll/items']) }}"><i
                            class="la la-money"></i>
                        <span> Payroll </span> <span class="menu-arrow"></span></a>
                    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                        <li><a class="{{ set_active(['form/salary/page']) }}" href="{{ route('form/salary/page') }}">
                                Employee Salary </a></li>
                        <li><a href="{{ route('form/salary/page') }}"> Payslip </a></li>
                        <li><a class="{{ set_active(['form/payroll/items']) }}" href="{{ route('form/payroll/items') }}">
                                Payroll Items </a></li>
                    </ul>
                </li> -->
                <li
                ...
                <li class="{{ set_active(['employee/profile/*']) }} submenu">
                    ...
                    <ul style="display: none;">
                        <li><a class="{{ set_active(['employee/profile/*']) }}" href="{{ route('all/employee/list') }}">
