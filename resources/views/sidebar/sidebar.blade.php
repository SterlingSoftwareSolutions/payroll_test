            ...
            <ul>
                ...
                <li
                    ...
                    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                        ...
                        <li><a class="{{set_active(['activity/log'])}}" href="{{ route('activity/log') }}">Activity
                                Log</a></li>
                ...
                <li class="{{set_active(['all/employee/list','all/employee/list','all/employee/card','form/holidays/new','form/leaves/new',
                    ...
                    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                        <li><a class="{{set_active(['all/employee/list'])}}" href="{{ route('all/employee/list') }}">All
                                Employees</a></li>
                        ...
                        <li><a class="{{set_active(['attendance/employee/page'])}}"
                                href="{{ route('attendance/employee/page') }}">Attendance <!----(Employee)  -------></a>
                        </li>
                ...
                <li
                    ...
                    <a href="#"
                        class="{{ set_active(['form/expense/reports/page','form/attendance/report/page','form/leave/reports/page','form/attendance/report/pdf/page']) ? 'noti-dot' : '' }}"><i
                            class="la la-pie-chart"></i>
