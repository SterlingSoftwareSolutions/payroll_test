...
<div class="sidebar" id="sidebar">
        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="{{set_active(['all/employee/list','all/employee/list','all/employee/card','form/holidays/new','form/leaves/new',
                    ...
                    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                        <li><a class="{{set_active(['all/employee/list'])}}" href="{{ route('all/employee/list') }}">All Employees</a></li>
                ...
                <li class="menu-title"> <span>Pay Roll</span> </li>
    <!----            <li class="{{set_active(['create/estimate/page','form/estimates/page','payments','expenses/page'])}} submenu">
                ...
                <li class="{{set_active(['form/expense/reports/page','form/attendance/report/page','form/leave/reports/page','form/attendance/report/pdf/page'])}} submenu">
                    <a href="#" class="{{ set_active(['form/expense/reports/page','form/attendance/report/page','form/leave/reports/page','form/attendance/report/pdf/page']) ? 'noti-dot' : '' }}"><i class="la la-pie-chart"></i>
