<style type="text/css">
    ...
    .logo img {
        max-width: 100%; /* Ensure the logo does not exceed its container width */
...
<body>
 ...
 <div class="logo">
    <img src="https://sterlinglanka.com/wp-content/uploads/2022/06/sterling_logo-300x82.png" alt="Logo">
</div>
    ...
    <div class="employee-table">
        <table>
            ...
            <tr>
                ...
                <<td style="text-align: right;">{{ $payslip->employee->j_status }}</td>
            </tr>
        </table>
    </div>
    <div class="employee-table">
