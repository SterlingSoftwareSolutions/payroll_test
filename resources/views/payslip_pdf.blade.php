...
.right-content {
    ...
    .left-content {
        flex: 0 0 30%;
        /* Set the width of the left content */
        float: left;
    }

    .right-content {
        flex: 1;
        /* Let the right content take up the remaining space */
        float: right;
    }
  ...
  color: #000000;
    ...
    .footer {
        ...
        /* Distribute items equally on the line */
        align-items: center;
    ...
    <table style='font-size: 13px; margin-left: 40px; padding-right: 80px'>
        ...
        <tr>
            ...
            <td style="text-align: right;">
                {{ $payslip->no_pay_leave_deduction ? number_format($payslip->no_pay_leave_deduction, 2) : '-' }}
            </td>
        </tr>
        <tr>
            <td style="width: 20%;">Late Deduction</td>
            <td style="text-align: right;">
                {{ $payslip->late_deduction ? number_format($payslip->late_deduction, 2) : '-' }}</td>
        </tr>
        <tr>
        ...
        <tr style="width: 50%">
            ...
            <td style="text-align: right; padding-right: 40%;">
                {{ $payslip->incentive1 ? number_format($payslip->incentive1, 2) : '-' }}</td>
        </tr>
        <tr style="width: 50%">
            <td style="width: 20%; padding-left: 33.33%;">Incentive - 2</td>
            <td style="text-align: right; padding-right: 40%;">
                {{ $payslip->incentive2 ? number_format($payslip->incentive2, 2) : '-' }}</td>
        </tr>
        <tr style="width: 50%">
            <td style="width: 20%; padding-left: 33.33%;">Increments</td>
            <td style="text-align: right; padding-right: 40%;">
                {{ $payslip->other_increments ? number_format($payslip->other_increments, 2) : '-' }}</td>
        </tr>
        <tr style="width: 50%">
            <td style="width: 50%; padding-left: 33.33%;">Attendance Allowance</td>
            <td style="text-align: right; padding-right: 40%;">
                {{ $payslip->attendance_allowance ? number_format($payslip->attendance_allowance, 2) : '-' }}</td>
        </tr>
        <tr style="width: 50%">
        ...
        <tr style="width: 50%">
            ...
            <td style="text-align: right; padding-right: 40%;">
                {{ $payslip->holiday_payment ? number_format($payslip->holiday_payment, 2) : '-' }}</td>
        </tr>
        ...
        <tr style="width: 50%">
            ...
            <td style="text-align: right; padding-right: 40%;">
                {{ $payslip->employee_epf ? number_format($payslip->employee_epf, 2) : '-' }}</td>
        </tr>
        <tr style="width: 50%">
        ...
        <tr style="width: 50%">
            ...
            <td style="text-align: right; padding-right: 40%;">
                {{ $payslip->loan ? number_format($payslip->loan, 2) : '-' }}</td>
        </tr>
        <tr style="width: 50%">
            <td style="width: 20%; padding-left: 33.33%;">Stamp Duty</td>
            <td style="text-align: right; padding-right: 40%;">
                {{ $payslip->stamp_duty ? number_format($payslip->stamp_duty, 2) : '-' }}</td>
        </tr>
        ...
        <tr class="highlight-row">
            ...
            <td style="text-align: right;">{{ $payslip->net_salary ? number_format($payslip->net_salary, 2) : '-' }}
            </td>
        </tr>
    </table>
